#Ejercicio 2 Marcos Obando

function [A, b] = Difusion(n)
  ...
  #A=full(SD+SU1+SU1'+SU2+SU2'+SU3+SU3');   #Para matrix llena
  A=SD+SU1+SU1'+SU2+SU2'+SU3+SU3';    #para matrix rala
  b= ones(N, 1)/(n+1)^2;% Para generar el vector segundo miembro
